<section class="pt-[5vw] relative bg-[#ffe6c7]">
  ...
  <div class="relative z-10">
    ...
    />
    <p
      class="markerfield z-10 text-white text-[2.3vw] absolute top-[21vw] left-[6vw] w-[25vw] text-center leading-[2.3vw]"
    >
      NAPI NYEREMÉNy: <br />
    ...
    <p
      class="markerfield z-10 text-white text-[3vw] absolute-center top-[20vw] w-[25vw] text-center leading-[3vw]"
    >
      FŐDÍJ: <br />
    ...
    <p
      class="markerfield z-10 text-white text-[2.3vw] absolute top-[21vw] right-[8vw] w-[25vw] text-center leading-[2.3vw]"
    >
      HETI NYEREMÉNY: <br />
      1 x Bosch <br />
      vezetéknélküli porszívó
    </p>
  </div>
</section>
